		  ...
		  <div class="float">
			...
			<div class="tagline">
			  ...
			  <?php
				printf(
					__(
						'To support future development and help to make it even better just leaving us a <a href="%1$s" title="Custom Permalinks Rating" target="_blank">%2$s</a> rating with a nice message to me :)',
						'custom-permalinks'
					),
